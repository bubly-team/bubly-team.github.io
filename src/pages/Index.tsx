          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 xl:gap-24">
            ...
            <div className="flex-1 flex justify-center items-center w-full">
              <div className="relative w-[240px] h-[240px] sm:w-[320px] sm:h-[320px] lg:w-[420px] lg:h-[420px]">
                ...
                {/* Floating Emojis - Campus & Friends theme - fewer on mobile */}
                <div className="absolute -top-2 left-4 sm:left-8 text-2xl sm:text-4xl animate-float-gentle" style={{ animationDuration: "4s" }}>🎓</div>
                <div className="absolute top-4 sm:top-8 -right-1 sm:-right-2 text-xl sm:text-3xl animate-float-gentle" style={{ animationDuration: "5s", animationDelay: "0.5s" }}>🎂</div>
                <div className="hidden sm:block absolute top-1/4 -left-4 text-3xl animate-float-gentle" style={{ animationDuration: "6s", animationDelay: "1s" }}>💝</div>
                <div className="absolute bottom-1/4 -right-1 sm:-right-2 text-2xl sm:text-4xl animate-float-gentle" style={{ animationDuration: "5.5s", animationDelay: "1.5s" }}>✨</div>
                <div className="absolute -bottom-2 left-8 sm:left-12 text-xl sm:text-3xl animate-float-gentle" style={{ animationDuration: "4.5s", animationDelay: "2s" }}>🎉</div>
                <div className="hidden sm:block absolute bottom-8 right-8 text-2xl animate-float-gentle" style={{ animationDuration: "5s", animationDelay: "2.5s" }}>📚</div>
                <div className="hidden md:block absolute top-1/2 -left-6 text-2xl animate-float-gentle" style={{ animationDuration: "6s", animationDelay: "0.8s" }}>🫶</div>
                <div className="hidden sm:block absolute top-12 left-1/4 text-xl animate-float-gentle" style={{ animationDuration: "5s", animationDelay: "1.2s" }}>☕</div>

                {/* Soft glow behind Bubbo */}
                <div className="absolute inset-0 m-8 sm:m-16 bg-gradient-radial from-bubly-violet/20 via-bubly-pink/10 to-transparent blur-2xl sm:blur-3xl rounded-full" />
                
                {/* Bubbo - Center with enhanced presence */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 scale-75 sm:scale-100">
                  <FollowCursorBubbo size="xl" />
                </div>

                {/* Decorative rings - hidden on mobile */}
                <div className="hidden sm:block absolute inset-0 m-4 rounded-full border border-bubly-sky/10 animate-spin-slow" style={{ animationDuration: "25s" }} />
                <div className="hidden sm:block absolute inset-0 m-12 rounded-full border border-dashed border-bubly-violet/10 animate-spin-slow" style={{ animationDuration: "35s", animationDirection: "reverse" }} />
              </div>
            </div>
          </div>
