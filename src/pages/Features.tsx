...
const Features = () => {
  return (
    <Layout>
      <SEO
        title="AI Birthday Messages & Smart Contact Manager"
        description="Generate personalized birthday wishes with AI. Smart reminders, friend tracker, and personal relationship management. Never forget a friend's special day."
        path="/features"
      />
